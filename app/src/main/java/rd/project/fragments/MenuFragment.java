...
public class MenuFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // Poster animation
        // Source: https://stackoverflow.com/q/36894384
        ImageView background13_extra = view.findViewById(R.id.poster_13_extra);
        ...
        background.addUpdateListener(background14 -> {
            float progress = (float) background14.getAnimatedValue() * 13;
